			...
			time()
				...
				//		goto label		//And go back to the beginning of the cycle.
					...
					if(ampm == "am")
						...
						if(day == 31)	//If day is above max (14 is max, so set this at 15)
							if(month == "January")		//From here...
								month = "Spring"
								day = 1
				...
				if (day == 1 && month == "Spring" && time2text(world.timeofday,"hh") == 24 && minute == 0)// && ampm == "am") //set the first 2 items to when a holiday starts. (Do not change the time2text(world.timeofday,"hh"), minute1, minute2 or ampm values!)
					world << "<font color = green><b>\ Happy Survival Day!</b>"								 //set the message.
				if (day == 7 && month == "Spring" && time2text(world.timeofday,"hh") == 24 && minute == 0)// && ampm == "am") //And it's just repeated from here...
					world << "<font color = green><b>\ Happy Effort Day!</b>"
				if (day == 5 && month == "Summer" && time2text(world.timeofday,"hh") == 24 && minute == 0)// && ampm == "am")
					world << "<font color = green><b>\ Happy Feast!</b>"
				if (day == 6 && month == "Autumn" && time2text(world.timeofday,"hh") == 24 && minute == 0)// && ampm == "am")
					world << "<font color = green><b>\ Happy Harvest!</b>"
				if (day == 17 && month == "Autumn" && time2text(world.timeofday,"hh") == 24 && minute == 0)// && ampm == "am")
					world << "<font color = green><b>\ Happy Bounty!</b>"
				if (day == 22 && month == "Winter" && time2text(world.timeofday,"hh") == 24 && minute == 0)// && ampm == "am")
					world << "<font color = green><b>\ Happy Celebrate Day!</b>"								 //...To here.
...
obj/sundial						//Yes, it tells the time.
	...
	Click()				//Give yourself a verb to examine the clock.
		...
		if(get_dist(src,usr)<=3)		//Makes sure you're close enough to read it (3 spaces)
			usr << "<font color = green> The Sundial reads: [time2text(world.timeofday,"hh")]:[minute][ampm] of Day: [day] / Season: [month] / Year: [year] O·C"	//It tells you the time.
