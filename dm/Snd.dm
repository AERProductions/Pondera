//Utilizing the built in byond sound system to replace soundmob. To interrupt a sound, use a blank sound file and play it with wait = 0 command
...
//options
//sound('filename', repeat = ,wait = ,channel = ,volume = ,frequency = ,len = ,offset = ,pan = ,priority = ,status = ,x =, y =, z = ,falloff = ,environment = ,echo = )
...
//var/sound/F1 = sound(file = 'snd/cleaned/fire2.ogg', repeat = 1,wait = 0,channel = 10,volume = 60,frequency = 0,len = 0,offset = 0,pan = 0,priority = 100,status = 0,x = 0,y = 0,z = 0,falloff = 8,environment = 15,echo = 0)
var/sound/F1 = sound('snd/cleaned/fire2.ogg', repeat = 1,wait = 0,channel = 10,volume = 60)//these work but there is no attenuation
var/sound/FM = sound('snd/cleaned/fire2.ogg', repeat = 1,wait = 0,channel = 10,volume = 0, environment=15, falloff=100, status=SOUND_UPDATE)//these work but there is no attenuation

sound
	Fire
		file = 'snd/cleaned/fire2.ogg'
		repeat = 1
		wait = 0
		channel = 10
		volume = 60
