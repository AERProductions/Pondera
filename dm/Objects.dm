			...
			Talk()
				...
				switch(K)
					if("Buy")
						...
						var/const/temp2 = "Energy Tonic: restores up to 24 energy::33 lucre"
						var/const/temp3 = "Large Vitae Vial: restores up to 64 HP::59 lucre"
						var/const/temp4 = "Strong Energy Tonic: restores up to 42 energy::64 lucre"
			...
			Talk()
				...
				switch(K)
					if("Buy")
						...
						var/const/temp2 = "Energy Tonic: restores up to 24 energy::35 lucre"
						var/const/temp3 = "Large Vitae Vial: restores up to 64 HP::120 lucre"
						var/const/temp4 = "Strong Energy Tonic: restores up to 42 energy::90 lucre"
						var/I = input("Items?","ITEMS") in list (temp1,temp2,temp3,temp4,"Leave")
						var/N
						if(I!="Leave")
							N = input("How many?","ITEMS") as num
			...
			Talk()
				...
				switch(K)
					if("Buy")
						...
						var/const/temp2 = "Energy Spirits: restores up to 64 energy::93 lucre"
						var/const/temp3 = "Quality Vitae Liniments: restores up to 113 HP::118 lucre"
						var/const/temp4 = "Strong Energy Spirits: restores up to 204 energy::124 lucre"
						var/I = input("Items?","ITEMS") in list (temp1,temp2,temp3,temp4,"Leave")
						var/N
						if(I!="Leave")
							N = input("How many?","ITEMS") as num
			...
			Talk()
				...
				switch(K)
					if("Buy")
						...
						var/const/temp2 = "Energy Restorative: restores up to 168 energy::204 lucre"
						var/const/temp3 = "Quality Vitae Curative: restores up to 264 HP::313 lucre"
						var/const/temp4 = "Strong energy Restorative: restores up to 224 energy::324 lucre"
			...
			Talk()
				...
				switch(K)
					if("Buy")
						...
						var/const/temp2 = "Large Strong Energy Restorative: restores up to 324 energy::444 lucre"
