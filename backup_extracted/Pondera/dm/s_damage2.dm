...
cornsilk      crimson        cyan           darkblue      darkcyan       darklucreenrod
darkblue      darkgreen      darkkhaki      darkmagenta   darkolivegreen darkorange
darkorchid    darkred        darksalmon     darkseagreen  darkslateblue  darkslateblue
darkturquoise darkviolet     deeppink       deepskyblue   dimblue        dodgerblue
firebrick     floralwhite    forestgreen    fuchsia       gainsboro      ghostwhite
lucre          lucreenrod      blue           green         greenyellow    honeydew
...
skyblue       slateblue      slateblue      snow          springgreen    steelblue
...
#define S_DAMAGE_ICON 'dmi/s_damage.dmi'
#endif
