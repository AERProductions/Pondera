// dm/SQLiteMigrations_v2.dm
// SQLite Schema Migrations & Error Recovery
// Simplified production-ready version (Fixed)
// Version: 2.0 (Fixed bracket issues)
// Date: 2025-12-17
...
proc/ValidatePlayerData(mob/players/P)
	...
	// Validate rank EXPs (should be >= 0)
	if(char.frankEXP < 0)
		char.frankEXP = 0
		data_valid = FALSE
...
proc/GetSQLiteStats()
	...
	var/list/stats = list()
	var/file_size = filesize(sqlite_db_path)
