...
/proc/InitializeKnowledgeBase()
	...
	// TODO: Recipe entry system requires rewrite to use proper BYOND syntax
	// Currently disabled: invalid named parameters in new() - BYOND doesn't support named parameters in constructors
	world.log << "[KNOWLEDGE] Knowledge base initialization disabled - recipe entry system needs BYOND-compliant syntax"
	return
