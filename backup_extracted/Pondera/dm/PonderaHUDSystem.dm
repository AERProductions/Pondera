...
/datum/PonderaHUD
	var
		...
		datum/StatusBars/status_bars
		datum/CharacterPanel/char_panel
		datum/ContinentSelector/continent_selector
		datum/EquipmentDisplay/equipment_display
		datum/QuickActionsMenu/quick_menu
		datum/SystemMessages/system_messages
		datum/ExtendedHUDManager/extended_hud
