...
/proc/UpdateMarketPriceDisplay(datum/treasury_ui_manager/manager)
	...
	manager.market_display.displayed_commodities = list(
		list("name" = "Stone", "price" = GetCommodityPrice("Stone"), "trend" = GetCommodityTrend("Stone")),
		list("name" = "Metal Ore", "price" = GetCommodityPrice("Metal Ore"), "trend" = GetCommodityTrend("Metal Ore")),
		list("name" = "Timber", "price" = GetCommodityPrice("Timber"), "trend" = GetCommodityTrend("Timber")),
...
/proc/GetTreasuryUIReport(kingdom_name)
	...
	output += "  Stone:  [round(GetCommodityPrice("Stone"), 0.01)] lucre\n"
	output += "  Metal:  [round(GetCommodityPrice("Metal Ore"), 0.01)] lucre\n"
	output += "  Timber: [round(GetCommodityPrice("Timber"), 0.01)] lucre\n\n"
