...
mob/BaseCamp/ChoosingCharacter
	ChooseCharacterMenu(list/menu)
		...
		<style type="text/css">
		 ...
		 :link { color: #20B728 }
		 :visited { color: #206B24 }
		</style>
		<table id="Layer0" class="c0" cellspacing="5" cellpadding="25" border="0">
		<tbody>
		[menu_rows]
		</tbody>
		</table>
	...
	DeleteCharacterMenu(list/menu)
		...
		<style type="text/css">
		 table.c1 {position:absolute; left:0px; top:0px; width:px; height:px; z-index:1}
		 table.c0 {position:absolute; left:73px; top:60px; width:px; height:px; z-index:2}
		</style>
		<style type="text/css">
		 body {
		  background-color: #206B24;
