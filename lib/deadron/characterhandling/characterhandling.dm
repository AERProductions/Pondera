...
mob/BaseCamp/ChoosingCharacter
	ChooseCharacterMenu(list/menu)
		...
		usr << browse_rsc('chcmenu.png', "chcmenu.png")
		usr << browse_rsc('cscmenu.png', "cscmenu.png")
		...
		usr << browse_rsc('dcmenu.png', "dcmenu.png")
		var/menu_rows = ""
		for (var/item in menu)
			menu_rows += {"<tr><td align="center"><font size=6><a href="?menu=choosing_character;choice=[item];src=\ref[src]">\[[item]]</a></font></td></tr>"}
		var/page = {"
		<style type="text/css">
		 ...
		 table.c0 {position:absolute; left:50px; top:60px; width:px; height:px; z-index:2}
		</style>
		<style type="text/css">
		 body {
		...
		<table id="Layer0" class="c0" cellspacing="5" cellpadding="15" border="0">
		<tbody>
		[menu_rows]
		</tbody>
		</table>
		...
		<tbody>
		<tr>
		<td><img src="cscmenu.png" alt="" border="0"></td>
		</tr>
		</tbody>
		</table>
		"}
	...
	DeleteCharacterMenu(list/menu)
		var/menu_rows = ""
		for (var/item in menu)
		//	menu_rows += {"<td align="center"><a href="?menu=deleting_character;choice=[item];src=\ref[src]"><img alt="" src="delete.png" border="0"></a></td>"}
			menu_rows += {"<tr><td align="center"><font size=6><a href="?menu=deleting_character;choice=[item];src=\ref[src]">\[[item]]</a></font></td></tr>"}
		var/page = {"
		<style type="text/css">
		 table.c1 {position:absolute; left:0px; top:0px; width:px; height:px; z-index:1}
		 table.c0 {position:absolute; left:50px; top:60px; width:px; height:px; z-index:2}
		...
		<tbody>
		<tr>
		<td><img src="dcmenu.png" alt="" border="0"></td>
		</tr>
		</tbody>
		</table>
		"}
	...
	QuitMenu(list/menu)
		var/menu_rows = ""
		for (var/item in menu)
			menu_rows += {"<td align="center"><a href="?menu=quit;choice=[item];src=\ref[src]"><img src="quit.png" border="0"></a></td>"}
		var/page = {"
		<style type="text/css">
		...
		<tbody>
		<tr>
		<td><img src="chcmenu.png" alt="" border="0"></td>
		</tr>
		</tbody>
		</table>
