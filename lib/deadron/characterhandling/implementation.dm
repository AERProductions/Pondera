...
mob/BaseCamp
	base_save_allowed = 1			// BaseCamp mobs are for admin only.
	...
	Login()
		...
		winset(usr,"default.bar8","is-visible=true")
		winset(usr,"default.bar9","is-visible=true")
		winset(usr,"default.bar10","is-visible=true")
		winset(usr,"default.bar11","is-visible=true")
		winset(usr,"default.bar12","is-visible=true")
		winset(usr,"default.bar13","is-visible=true")
