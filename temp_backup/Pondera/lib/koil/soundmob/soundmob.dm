...
proc
	...
	soundmob(atom/movable/attached, radius = 0, file, autotune = TRUE, channel = 0, volume = 100)
...
soundmob
	...
	New(mob/_attached, _radius = 0, _file, _autotune = TRUE, _channel = 0, _volume = 100)
		ASSERT(_attached && _file && _radius)
