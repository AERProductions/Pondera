world
	New()
		...
		HtmlAssosciate("darklucreenrod","b8b60b")
		...
		HtmlAssosciate("darkslateblu","2f4f4f")
		...
		HtmlAssosciate("emerald","50c878")
		HtmlAssosciate("firebrick","932a12")
		HtmlAssosciate("flatdarkearth","b2a68c")
		...
		HtmlAssosciate("lucre","ffd700")
		HtmlAssosciate("lucreenrod","daa520")
		...
		HtmlAssosciate("lightlucreenrodyellow","fafad2")
		...
		HtmlAssosciate("lightorange","f99245")
		HtmlAssosciate("lime","00ff00")
		HtmlAssosciate("limegreen","32cd32")
		HtmlAssosciate("linen","faf0e6")
		HtmlAssosciate("magenta","ff00ff")
		HtmlAssosciate("bloodred","660000")
		HtmlAssosciate("moon","e3e1D7")
		HtmlAssosciate("sunsetorange","fd535e")
		HtmlAssosciate("sunrise","ffca7c")
		HtmlAssosciate("sun","f9d71c")
		...
		HtmlAssosciate("navajowhite","ffdead") //f-ed up color code named after natives, why internet? Why...
		HtmlAssosciate("navy","4b7bdc")
		...
		HtmlAssosciate("palelucreenrod","eee8aa")
		...
		HtmlAssosciate("obsidian","3d5b43")
		HtmlAssosciate("seashell","fff5ee")
		HtmlAssosciate("sienna","a0522d")
		HtmlAssosciate("silver","c0c0c0")
		HtmlAssosciate("platinum","e6e8fa")
		HtmlAssosciate("stainlesssteel","4b7bdc")
		HtmlAssosciate("copper","b87333")
		HtmlAssosciate("bronze","8c7853")
		HtmlAssosciate("gold","ffd700")
		HtmlAssosciate("skyblue","87ceed")
		HtmlAssosciate("slateblue","6a5acd")
		HtmlAssosciate("slategray","c0c2c9")
		HtmlAssosciate("slateblu","708090")
		HtmlAssosciate("steel","caccce")
