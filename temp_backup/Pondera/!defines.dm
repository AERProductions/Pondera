...
#define RANK_ARCHERY "archery_rank"             // Archery/Bows rank
#define RANK_CROSSBOW "crossbow_rank"           // Crossbow rank
#define RANK_THROWING "throwing_rank"           // Throwing rank (knives, javelins)
